...
import gamePlay.boardGrid.boardGrid;
                        ...
                        return new TableCell<>() {
...

                            {
                                button.setOnAction((ActionEvent event) -> {
                                    ...
                                    primaryStage.setScene(gamePlay.boardGrid.boardScene.makeScene(primaryStage));
                                });
...
//        stackPane.setStyle("-fx-background-color: transparent");
        ...
        savedScene.getStylesheets().add("gamePlay/boardGrid/style.css");
